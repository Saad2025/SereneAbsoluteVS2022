namespace SereneAbsoluteDemoForVS2022
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want SereneAbsoluteDemoForVS2022 migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "SereneAbsoluteDemoForVS2022.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
